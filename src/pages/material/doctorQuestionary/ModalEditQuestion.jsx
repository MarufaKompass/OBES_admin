...
import { adminProfile, CategoryView, editDoctorQuesUpdate } from "@/hooks/ReactQueryHooks";
...
export default function ModalEditQuestion({ setShowModalEdit, showModalEdit, selectedQuestion }) {
    ...
    const { mutateAsync } = useMutation({ mutationFn: editDoctorQuesUpdate });

    const onSubmit = async (data) => {
        try {
            const res = await mutateAsync({ editDoctorUpdateData: data, role: profile?.role, id: selectedQuestion?.id });
