                            ...
                            <form onSubmit={handleSubmit(onSubmit)}  >
                                <CardBody className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input label="Question English" type="text" defaultValue={selectedNewsLetterId?.qeng}   {...register("qeng", { required: true })} />
                                    </div>
                                    <div className="space-y-2">
                                        <Typography variant="small" color="blue-gray" className="font-medium">
                                            প্রশ্ন (বাংলা)
                                        </Typography>
                                        <Input label="প্রশ্ন বাংলা" type="text" defaultValue={selectedNewsLetterId?.qbang}   {...register("qbang", { required: true })} />
                                    </div>
