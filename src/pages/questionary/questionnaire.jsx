...
export default function Questionnaire() {
  ...
  return (
    <div className=" min-h-screen flex items-center justify-center px-4 py-10 mt-4 bg-background shadow-xl rounded-2xl">
      <Card className="max-w-3xl shadow-lg rounded-lg border border-gray-200 bg-white ">
        <CardHeader
          floated={false}
          shadow={false}
